...
class PLocalidad extends Component {
    ...
    render() {
        ...
        const FotoRandom = () => <img className="img-fluid" src={`${process.env.REACT_APP_API_RECURSOS}/atractivos/${selecciono}`} alt="Img" />
        return (
                                        ...
                                        <div id="atractivos">
                                            <Link to={`/atractivos/${this.state.dataLocalidad.id}`}>
                                                <div className="all-link">
                                                    <div className="al-nombre" style={{color: `#${this.state.dataLocalidad.color}`}}>{this.state.dataLocalidad.nombre}</div>
                                                    <div className="al-texto" style={{color: `#${this.state.dataLocalidad.color}`}}>ATRACTIVOS TURÍSTICOS</div>
                                                    <div className="al-boton" style={{color: `#${this.state.dataLocalidad.color}`}}><i className="fas fa-arrow-alt-circle-right"></i></div>
                                                </div>
                                            </Link>
                                        </div>
                                        <div id="mapa">
